...
# Caricamento dell'immagine del bot (inserisci il percorso corretto dell'immagine)
bot_image = pygame.image.load(r"png_database\reyna.png")  # Assicurati di avere il file immagine nella stessa directory o specifica il percorso corretto
bot_image = pygame.transform.scale(bot_image, (100, 200))  # Scala l'immagine alle dimensioni desiderate
...
def game_loop():
    bots = [Bot() for _ in range(15)]  # Genera 5 bot
    score = 0
    game_over = False
