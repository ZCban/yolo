...
center_x_screenshot = (left + right) // 2

# Define the camera's field of view (FOV) in degrees
fov = 90  # Example FOV value
...
while True:
    ...
    for box in boxes:
        ...
        error_x = center_x - center_x_screenshot
        steering_angle = error_x * angle_per_pixel  # Calculate steering angle
        ...
        #cv2.putText(img, f'Steering Angle: {steering_angle:.2f}', (10, 30),
